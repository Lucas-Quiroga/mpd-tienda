...
import { c as cn, B as Button, d as buttonVariants, u as updateSearchParams } from './ThemeScript_B1KfZH_o.mjs';
...
function ModeToggle() {
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", children: [
      ...
      /* @__PURE__ */ jsx(DropdownMenuItem, { onClick: () => setTheme("dark"), children: "Oscuro" }),
